...
if __name__ == "__main__":
    ...
    parser.add_argument("--dependabot-workaround", type=bool, default=False, help="transfer-encoding support in the dependabot proxy is broken, it rewraps the raw chunks. This is a workaround.")
